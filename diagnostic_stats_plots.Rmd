...
test_model <- akGLpls_intv
df_used <-  akGL_wetChemAbs_intervals
actual_bsi_only <- akGL_wetChemAbs_intervals$BSi
```
...
for (i in 2:test_model$ncomp){ 
    ...
    BSi_Long <- BSi %>%
      select(dataset, BSiPercent_Actual, BSiPercent_Predicted)%>%
