...
```{r test-fig, fig.cap="test figure", echo=FALSE}
plot(rnorm(10),rnorm(10))

#none of the references are working despite being character for character identical with what he's writing. lovely.
```
...
# okay the table reference is working for some goddamned reason, fuck if I know
```
